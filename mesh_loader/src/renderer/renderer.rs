// Developed from tutorial: Learn OpenGL with Rust: textures by Yuri Samkevich
// https://dev.to/samkevich/learn-opengl-with-rust-textures-3lg8
// https://github.com/samkevich/learn_gl_with_rust/tree/main

// TODO: Use tobj to load objects, display with a loop to create a buffer object with data
// draw buffer object to go through the two vectors
...
impl Renderer {
    pub fn new() -> Result<Self, RendererInitError> {
        unsafe {
            ...
            texture0.load(&Path::new("src/assets/logo.png"))?;
            ...
            texture1.load(&Path::new("src/assets/Capture.JPG"))?;
